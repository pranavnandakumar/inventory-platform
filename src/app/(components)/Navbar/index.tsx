        ...
        <div className = "flex justify-between items-center gap-5">
            <div className = "hidden md:flex justify-between items-center gap-5">
                ...
                <div className = "relative">
                    ...
                    <span className = "absolute -top-2 -right-2 inline-flex items-center justify-cent px-[0.4rem] py-1 text-xs font-semibold leading-non text-red-100 bg-red-400 rounded-full">
                        3
                    </span>
                </div>
                ...
                <div className = "flex items-center gap-3 cursor-pointer">
                    <div className = "w-9 h-9">
                        image
                    </div><span className = "font-semibold">Pranav Nandakumar</span>
                </div>
            </div>
            <Link href = "/setting">
